...
const PREFERENCES_ROUTE = "/onboarding/preferences";

export function SignInClient({ availability }: SignInClientProps) {
  const handleGuestContinue = () => {
    saveOnboardingState({ authMode: "guest" });
  };

  const handleGoogleSignIn = () => {
    void signIn("google", { redirectTo: PREFERENCES_ROUTE });
  };
        ...
        <section className="mt-8">
          <AuthOptionGroup>
            <AuthOption
              ...
              badge="Soon"
              disabled
              ariaLabel="Continue with Apple — coming soon"
            />
            {availability.google ? (
              <AuthOption
            ...
            <AuthOption
              ...
              badge="Soon"
              disabled
              ariaLabel="Continue with Aeroplan — coming soon"
            />
            <AuthOption
              ...
              badge="Soon"
              disabled
              ariaLabel="Continue with email — coming soon"
            />
          </AuthOptionGroup>
        </section>
